...
function Footer() {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 8 7" fill="none">
    <g clipPath="url(#clip0_32_159)">
      <path d="M2.42487 6.69157V2.52335H1.02694V6.69157H2.42487ZM1.72608 1.95391C2.21357 1.95391 2.517 1.63384 2.517 1.23386C2.50792 0.824859 2.21358 0.513672 1.73533 0.513672C1.25716 0.513672 0.944458 0.824865 0.944458 1.23386C0.944458 1.63386 1.24782 1.95391 1.71696 1.95391H1.72604H1.72608ZM3.19862 6.69157H4.59655V4.36384C4.59655 4.23926 4.60563 4.11481 4.64255 4.02576C4.74361 3.77686 4.97362 3.51906 5.35979 3.51906C5.86564 3.51906 6.06801 3.9013 6.06801 4.46164V6.69154H7.46586V4.30153C7.46586 3.02121 6.77619 2.4255 5.85644 2.4255C5.10231 2.4255 4.7712 2.84326 4.58725 3.12779H4.59658V2.52327H3.19865C3.21699 2.91439 3.19865 6.69149 3.19865 6.69149L3.19862 6.69157Z" fill="white" />
    </g>
    <defs>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 8 8" fill="none">
    ...
    <defs>
      <clipPath id="clip0_32_164">
        <rect width="6.58976" height="7.41348" fill="white" transform="translate(0.731049 0.101929)" />
      </clipPath>
    </defs>
  </svg>
</div>
          ...
          <div className="col-md-8 d-flex flex-column gap-1 align-items-flex-start" style={{color:"#fff"}}>
            ...
            <a className="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href='#'> About our store</a>
            <a className="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href='#'>Connect with us</a>
            <a className="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href='#'>Exchange and return policy</a>
            <a className="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href='#'>Terms and Conditions</a>
            <a className="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href='#'>Usage policy</a>
          </div>
      </div>
